...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_nolabel, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
    b.optional :min_max
    b.optional :readonly
    b.wrapper tag: 'div', class: 'col-sm-8 col-sm-offset-4' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
  ...
  config.wrappers :raw, :tag => 'div', :error_class => 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :input, class: 'form-control'
  end
